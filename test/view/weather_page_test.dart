...
void main() {
  ...
  group('WeatherView', () {
    ...
    testWidgets('renders WeatherEmpty for WeatherStatus.failure',
        (tester) async {
      when(() => weatherCubit.state).thenReturn(WeatherState(
    ...
    testWidgets('renders WeatherEmpty for WeatherStatus.loading',
        (tester) async {
      when(() => weatherCubit.state).thenReturn(WeatherState(
    ...
    testWidgets('renders WeatherEmpty for WeatherStatus.success',
        (tester) async {
    ...
    testWidgets('navigates to SearchPage when settings icon is tapped',
        (tester) async {
      when(() => weatherCubit.state).thenReturn(WeatherState());
      await tester.pumpWidget(BlocProvider.value(
        value: weatherCubit,
